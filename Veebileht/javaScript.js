...
const paevNimi = ["Esmaspäev", "Teisipäev", "Kolmapäev", "Neljapäev", "Reede", "Laupäev", "Pühapäev"];
...
function kuupaev() {
  var today = new Date();
  var kuu = today.getMonth();
  var nadalapaev = today.getDay();
  var paev = today.getDate();
  E_kuupaev.innerHTML = paevNimi[nadalapaev - 1] + " " + paev + " " + kuuNimed[kuu];
